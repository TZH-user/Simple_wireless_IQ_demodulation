...
/* Vpp sweep parameters. Each point uses half-DMA ADC blocks. */
...
#define APP_SIGDET_VPP_UART_TRACE_ENABLE      1U
#endif

#define APP_SIGDET_STAGE_VPP_SCAN             0U
#define APP_SIGDET_STAGE_VPP_LOCKED           1U
