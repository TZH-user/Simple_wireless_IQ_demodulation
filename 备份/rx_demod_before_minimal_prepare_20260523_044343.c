...
#define RX_FM_CMSIS_BLOCK_MAX      4096U
...
static int32_t rx_iq_phase_diff_freq(int32_t i_now, int32_t q_now)
{
    int32_t di;
    int32_t dq;
    int64_t num;
                                   ...
                                   uint16_t *dac_out)
{
    ...
    if (n > RX_FM_CMSIS_BLOCK_MAX)
    {
        n = RX_FM_CMSIS_BLOCK_MAX;
    }
