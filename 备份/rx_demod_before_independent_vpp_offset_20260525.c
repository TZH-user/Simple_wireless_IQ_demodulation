...
#define RX_AM_DEBUG_LOG_ENABLE 1U
...
#define RX_FSK_DEBUG_LOG_ENABLE 1U /* 打开后输出 FSK 判决关键量，用于排查 warmup、双簇和参数传递问题。 */
...
#define RX_ASK_DEBUG_LOG_ENABLE 1U
...
#define RX_PSK_DEBUG_LOG_ENABLE 1U
