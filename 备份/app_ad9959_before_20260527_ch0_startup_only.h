...
/* 上电默认输出开关：1 表示初始化后四路输出默认 100 kHz 正弦，扫频缓存也会带默认幅度。 */
#define APP_AD9959_STARTUP_OUTPUT_ENABLE 1U
/* 上电初始化使用的幅度码；关闭默认输出时写 0，后续扫频/OCXO/任务仍可重新设置幅度。 */
#define APP_AD9959_STARTUP_AMP_CODE \
  ((APP_AD9959_STARTUP_OUTPUT_ENABLE != 0U) ? APP_AD9959_DEFAULT_AMP_CODE : 0U)
