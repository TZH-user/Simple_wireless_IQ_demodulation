...
/* Private defines -----------------------------------------------------------*/
#define CH_OUT_Pin GPIO_PIN_6
#define CH_OUT_GPIO_Port GPIOI
#define AD9959_SDIO2_Pin GPIO_PIN_5
#define AD9959_SDIO2_GPIO_Port GPIOI
#define CH_IN_Pin GPIO_PIN_4
#define CH_IN_GPIO_Port GPIOI
...
#define RANG_Pin GPIO_PIN_8
#define RANG_GPIO_Port GPIOA
