...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOI, CH_OUT_Pin|AD9959_SDIO2_Pin|CH_IN_Pin|TOUCH_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RANG_GPIO_Port, RANG_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, TOUCH_SDA_Pin|TOUCH_SCLK_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : CH_OUT_Pin CH_IN_Pin TOUCH_RST_Pin */
  GPIO_InitStruct.Pin = CH_OUT_Pin|CH_IN_Pin|TOUCH_RST_Pin;
  ...
  /*Configure GPIO pin : RANG_Pin */
  GPIO_InitStruct.Pin = RANG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(RANG_GPIO_Port, &GPIO_InitStruct);
