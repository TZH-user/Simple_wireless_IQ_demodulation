...
/*
 * UI 背景只在开机动画结束后装载，安全复用第二帧缓冲；避免额外占用 768 kB SDRAM。
 * 禁止在背景处于显示状态时再次把 APP_BOOT_FB_ADDR 当动画写缓冲使用。
 */
#define APP_UI_WALLPAPER_BUF_ADDR      APP_BOOT_FB_ADDR
#define APP_UI_WALLPAPER_BUF_SIZE_BYTES APP_FB_SIZE_BYTES
